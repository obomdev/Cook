...
namespace Cook.Migrations
{
    ...
    [Migration("20241008223246_criarBanco")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cook.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cook.Models.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DataCometario")
            ...
            modelBuilder.Entity("Cook.Models.Ingrediente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cook.Models.Receita", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cook.Models.ReceitaIngrediente", b =>
                {
                    b.Property<int>("ReceitaId")
                        .HasColumnType("int")
                        .HasColumnOrder(1);
            ...
            modelBuilder.Entity("Cook.Models.Usuario", b =>
                {
                    b.Property<string>("UsuarioId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ddf093a6-6cb5-4ff7-9a64-83da34aee005",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5d627e06-6991-4032-8abe-2dbe74d649fe",
                            Email = "admin@gcook.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GCOOK.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEOkxdvrDlAmoykNnFYfFyVZHf4q+pmLYYCWV0QTPu9uZ+WNEaeS9fcyMM17FGqyv8A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d1685cfd-bf2e-4e75-9085-4a3520302485",
            ...
            modelBuilder.Entity("Cook.Models.Comentario", b =>
                {
                    b.HasOne("Cook.Models.Receita", "Receita")
                        .WithMany()
                        .HasForeignKey("ReceitaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cook.Models.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("Cook.Models.Receita", b =>
                {
                    b.HasOne("Cook.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("Cook.Models.ReceitaIngrediente", b =>
                {
                    b.HasOne("Cook.Models.Ingrediente", "Ingrediente")
                        .WithMany("Receitas")
