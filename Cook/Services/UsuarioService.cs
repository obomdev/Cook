...
public class UsuarioService : IUsuarioService
{
    ...
    public async Task<List<string>> RegistrarUsuario(RegistroVm registro)
    {
        ...
        if (result.Succeeded)
        {
            _logger.LogInformation($"Novo usuário resgistrado com o email {user.Email}.");
            ...
            await _emailSender.SendEmailAsync(registro.Email, "Cook - Criação de Conta", GetConfirmEmailHtml(HtmlEncoder.Default.Encode(url)));
